...
try:
    model = tf.keras.models.load_model('model/cat_sound_model.h5')
...
def get_prediction_message(label):
    ...
    label = label.lower()
    messages = {
        'happy': "Your cat sounds happy! 😊",
        'angry': "Your cat sounds angry. 😠",
        'defense': "Your cat is defensive. 🛡️",
        'fighting': "Your cat is fighting. ⚔️",
        'huntingmind': "Your cat is in hunting mode. 🐾",
        'mating': "Your cat is calling for mating. ❤️",
        'mothercall': "Mother call detected. 🐱",
        'paining': "Your cat seems in pain. 😿",
        'resting': "Your cat is resting. 😴",
        'warning': "Warning sound detected. ⚠️"
    }
